...
const HibernateIcon = (props: React.SVGProps<SVGSVGElement>) => (
  <svg viewBox="0 0 128 128" {...props}>
    <path fill="#59666C" d="M110.1,42.2c-11.5-3.3-20.9-12.8-23.7-24.9c-0.6-2.6-1.3-5-2.2-7.3c-1.2-3.1-4.1-5.2-7.4-5.2c-0.4,0-0.8,0-1.2,0.1 C61.1,6.8,49.2,16.5,45.4,30.3c-2.4,8.7-1.3,17.9,3.1,25.6c4.6,8,12.3,13.7,21.3,15.5c0.8,0.2,1.6,0.2,2.4,0.2 c3.9,0,7.3-2.6,8.2-6.4c0.5-2.2,0.3-4.5-0.6-6.6C77,50.1,75.4,43,78.8,37.3c2-3.3,5.5-5.1,9.2-4.9c2.3,0.1,4.4,1.3,5.7,3 c1.6,2.1,2.1,4.8,1.2,7.3c-2.3,6.3-0.2,13.1,5.3,16.9c2.8,1.9,6.2,2.3,9.4,1.1c3.3-1.2,5.8-3.8,6.8-7.1c0.1-0.3,0.1-0.6,0.2-0.8 C120.2,46.5,115.5,43.2,110.1,42.2z" />
    <path fill="#BDBDBD" d="M68,76.5c-15.1-0.2-28.7,6.8-37.4,18.4C21.1,107.5,17.4,120.3,23.3,126c5.8,5.7,18.1-0.5,30.2-10.2 c12.6-10.1,21.8-21.2,22.3-33.8c0.1-2.6-0.5-5.2-1.8-7.4C72.1,72.2,70.2,71.5,68,71.5c-1.3,0-2.6,0.4-3.7,1.1 C63.4,73.1,63,74.2,63.1,75.4c0.1,2.2,1.3,4.2,3,5.6c2.4,2,5.5,2.5,8.4,1.4c2.6-1,4.7-2.9,6-5.4c0.7-1.3,1-2.8,1-4.3 C81.5,72.5,75.4,76.6,68,76.5z" />
  </svg>
);
...
const JUnitIcon = (props: React.SVGProps<SVGSVGElement>) => (
  <svg viewBox="0 0 128 128" {...props}>
    <path fill="#D9272D" d="M110.4,64c0,25.6-20.8,46.4-46.4,46.4S17.6,89.6,17.6,64S38.4,17.6,64,17.6S110.4,38.4,110.4,64z" />
    <path fill="#231F20" d="M82.1,38.1l-6.8,4.4c-4.4,2.9-7.2,7.7-7.2,13v0.2h15.9c3.2,0,5.9-2.6,5.9-5.9V38.1H82.1z" />
    <path fill="#FFFFFF" d="M54.5,72.4H42.7V46.6h11.8c5.4,0,9.7,1.2,13.1,3.7c3.3,2.5,5,6.3,5,11.1c0,4.9-1.7,8.7-5.1,11.2 C64.2,71.1,59.8,72.4,54.5,72.4z M52.6,65.9h1.1c3.1,0,5.5-0.7,7.1-2.1c1.6-1.4,2.5-3.6,2.5-6.6c0-3-0.8-5.2-2.5-6.6 c-1.7-1.4-4-2.1-7.1-2.1h-1.1V65.9z" />
  </svg>
);
